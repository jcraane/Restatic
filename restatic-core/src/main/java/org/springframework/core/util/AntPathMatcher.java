...
/**
 * org.springframework.core.util.PathMatcher implementation for Ant-style path patterns. Examples are provided below.
 * <p/>
...
public class AntPathMatcher implements PathMatcher {
    ...
    protected boolean doMatch(final String pattern, final String path, final boolean fullMatch,
        ...
        String[] patternDirs = StringUtils.tokenizeToStringArray(pattern, this.pathSeparator);
        ...
        while (pattIdxStart <= pattIdxEnd && pathIdxStart <= pathIdxEnd) {
            String patDir = patternDirs[pattIdxStart];
            if ("**".equals(patDir)) {
                break;
            }
        ...
        if (pathIdxStart > pathIdxEnd) {
            ...
            if (pattIdxStart == pattIdxEnd && patternDirs[pattIdxStart].equals("*") && path.endsWith(this.pathSeparator)) {
                return true;
            }
        ...
        // up to last '**'
        while (pattIdxStart <= pattIdxEnd && pathIdxStart <= pathIdxEnd) {
            String patDir = patternDirs[pattIdxEnd];
            if (patDir.equals("**")) {
                break;
            }
